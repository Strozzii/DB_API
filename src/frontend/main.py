...
class Main:
    ...
    def run(self) -> None:
        ...
        # mongodb_risk_target_dict = self.data.get_mongo_data(atts=["title", "category"], limit=4)
        ...
        # mongodb_risk_dict = self.data.get_data(query={'risk_id': 1}, filter_dict={'risk_id': "RISK-005"})
